...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return MonthFormat; });
/* unused harmony export DATE_FORMAT */
/* unused harmony export MONTH_NAMES */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DEFAULT_I18N; });
var DateFormat;
(function (DateFormat) {
    DateFormat[DateFormat["MM/YY"] = 0] = "MM/YY";
    DateFormat[DateFormat["MM/YYYY"] = 1] = "MM/YYYY";
    DateFormat[DateFormat["YY/MM"] = 2] = "YY/MM";
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return valuesToMask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return valuesFromMask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return rangeCreator; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Translator__ = __webpack_require__(6);

var valuesToMask = function (month, year, translate) {
    var t = translate || new __WEBPACK_IMPORTED_MODULE_0__Translator__["a" /* default */]();
...
var valuesFromMask = function (maskedValue) {
    var _a = maskedValue.split('/'), monthVal = _a[0], yearVal = _a[1];
...
var rangeCreator = function (start, count) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__i18n__ = __webpack_require__(2);

var merge = __webpack_require__(32);
var Translator = /** @class */ (function () {
    function Translator(lang, i18n) {
        this.i18n = merge({}, __WEBPACK_IMPORTED_MODULE_0__i18n__["a" /* DEFAULT_I18N */], i18n || {});
        this.lang = lang || 'default';
    }
    Translator.prototype.dateFormat = function () {
        var dateFormat = this.i18n.dateFormat[this.lang];
        if (dateFormat) {
            return dateFormat;
        }
        else {
    ...
    Translator.prototype.monthName = function (name) {
        if (this.i18n.monthFormat === __WEBPACK_IMPORTED_MODULE_0__i18n__["b" /* MonthFormat */].SHORT) {
    ...
    Translator.prototype.monthNames = function () {
        var names = this.i18n.monthNames[this.lang];
        if (names) {
            return names;
        }
        else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_month_picker_input__ = __webpack_require__(20);
var _this = this;
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render((__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null,
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", { htmlFor: "ex-0" },
        "Without default value",
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_month_picker_input__["a" /* default */], { inputProps: { id: "ex-0", name: "ex-0" } })),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", { htmlFor: "ex-1" },
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", { htmlFor: "ex-4" },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_month_picker_input__["a" /* default */], { closeOnSelect: true, inputProps: { id: "ex-3", name: "ex-3" } })),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", { htmlFor: "ex-2" },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_month_picker_input__["a" /* default */], { inputRef: function (ref) {
                _this.input = ref;
            }, year: new Date().getFullYear(), month: new Date().getMonth(), inputProps: { id: "ex-2", name: "ex-2" }, onChangeYearUpdate: false })),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", null,
        "asd",
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { placeholder: "Year", id: "ex-5-year", type: "number", onChange: function (e) { return _this.setState({ year: parseInt(e.target.value) || 2018 }); } }),
...
"use strict";
/* unused harmony export DEFAULT_I18N */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_input_mask__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__i18n__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Translator__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__styles_index_css__ = __webpack_require__(35);
...
/* unused harmony reexport DateFormat */
/* unused harmony reexport MonthFormat */
...
var DEFAULT_I18N = __WEBPACK_IMPORTED_MODULE_4__i18n__["a" /* DEFAULT_I18N */];
;
;
var MonthPickerInput = /** @class */ (function (_super) {
    ...
    function MonthPickerInput(props) {
        ...
        _this.valuesToMask = function (month, year) {
            if (typeof year == 'number' && typeof month == 'number') {
                return Object(__WEBPACK_IMPORTED_MODULE_3__utils__["c" /* valuesToMask */])(month, year, _this.t);
            }
            else
                return '';
        };
        ...
        _this.onInputChange = function (e) {
            ...
            if (mask.length && mask.indexOf('_') === -1) {
                var _a = Object(__WEBPACK_IMPORTED_MODULE_3__utils__["b" /* valuesFromMask */])(mask), month = _a[0], year = _a[1];
                var inputValue = _this.valuesToMask(month, year);
        ...
        _this.inputProps = function (_a) {
            ...
            return Object.assign({}, {
                ...
                mask: _this.inputMask,
                placeholder: customPlaceholder ? customPlaceholder : _this.t.dateFormat(),
                type: 'text',
...
/* harmony default export */ __webpack_exports__["a"] = (MonthPickerInput);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_parseMask__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_environment__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_string__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_defer__ = __webpack_require__(26);
...
function (_React$Component) {
  ...
  _proto.componentDidMount = function componentDidMount() {
    this.isAndroidBrowser = Object(__WEBPACK_IMPORTED_MODULE_2__utils_environment__["a" /* isAndroidBrowser */])();
    this.isWindowsPhoneBrowser = Object(__WEBPACK_IMPORTED_MODULE_2__utils_environment__["c" /* isWindowsPhoneBrowser */])();
    this.isAndroidFirefox = Object(__WEBPACK_IMPORTED_MODULE_2__utils_environment__["b" /* isAndroidFirefox */])();
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    this.maskOptions = Object(__WEBPACK_IMPORTED_MODULE_1__utils_parseMask__["a" /* default */])(nextProps.mask, nextProps.maskChar, nextProps.formatChars);
    ...
    if (isMaskChanged || this.maskOptions.mask && (newValue || showEmpty)) {
      newValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["b" /* formatValue */])(this.maskOptions, newValue);

      if (isMaskChanged) {
        var pos = this.lastCursorPos;
        var filledLen = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["c" /* getFilledLength */])(this.maskOptions, newValue);

        if (pos === null || filledLen < pos) {
          if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["g" /* isFilled */])(this.maskOptions, newValue)) {
            pos = filledLen;
          } else {
    ...
    if (this.maskOptions.mask && Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["f" /* isEmpty */])(this.maskOptions, newValue) && !showEmpty && (!this.hasValue || !nextProps.value)) {
      newValue = '';
    }
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "getLeftEditablePos", {
    ...
    value: function value(pos) {
      for (var i = pos; i >= 0; --i) {
        if (!Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["h" /* isPermanentChar */])(_this3.maskOptions, i)) {
          return i;
        }
      }
  ...
  Object.defineProperty(this, "setCursorToEnd", {
    ...
    writable: true,
    value: function value() {
      var filledLen = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["c" /* getFilledLength */])(_this3.maskOptions, _this3.value);
  ...
  Object.defineProperty(this, "onChange", {
    ...
    value: function value(event) {
      ...
      if (_this3.backspaceOrDeleteRemoval) {
        ...
        if (selection.length) {
          value = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["a" /* clearRange */])(_this3.maskOptions, value, selection.start, selection.length);
          ...
          if (editablePos !== null) {
            if (!maskChar) {
              value = value.substr(0, Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["c" /* getFilledLength */])(_this3.maskOptions, value));
            }

            value = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["a" /* clearRange */])(_this3.maskOptions, value, editablePos, 1);
        ...
        clearedValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["a" /* clearRange */])(_this3.maskOptions, value, startPos, maskLen - startPos);
        clearedValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["e" /* insertString */])(_this3.maskOptions, clearedValue, enteredString, cursorPos);
        value = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["e" /* insertString */])(_this3.maskOptions, oldValue, enteredString, cursorPos);

        if (enteredStringLen !== 1 || cursorPos >= prefix.length && cursorPos < lastEditablePos) {
          cursorPos = Math.max(Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["c" /* getFilledLength */])(_this3.maskOptions, clearedValue), cursorPos);
        ...
        clearedValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["a" /* clearRange */])(_this3.maskOptions, oldValue, selection.end, removedLen);

        if (maskChar) {
          value = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["e" /* insertString */])(_this3.maskOptions, clearedValue, enteredString, 0);
        }

        clearedValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["a" /* clearRange */])(_this3.maskOptions, clearedValue, selection.end, maskLen - selection.end);
        clearedValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["e" /* insertString */])(_this3.maskOptions, clearedValue, enteredString, 0);
      ...
      value = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["b" /* formatValue */])(_this3.maskOptions, value);
    ...
    value: function value(event) {
      ...
      if (_this3.maskOptions.mask) {
        if (!_this3.value) {
          ...
          var value = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["b" /* formatValue */])(_this3.maskOptions, prefix);
          var inputValue = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["b" /* formatValue */])(_this3.maskOptions, value); // do not use this.getInputValue and this.setInputValue as this.input
        ...
        } else if (Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["c" /* getFilledLength */])(_this3.maskOptions, _this3.value) < _this3.maskOptions.mask.length) {
          _this3.setCursorToEnd();
        }
      }
  ...
  Object.defineProperty(this, "onBlur", {
    ...
    value: function value(event) {
      ...
      if (_this3.maskOptions.mask && !_this3.props.alwaysShowMask && Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["f" /* isEmpty */])(_this3.maskOptions, _this3.value)) {
        var inputValue = '';
  ...
  Object.defineProperty(this, "pasteText", {
    ...
    value: function value(_value3, text, selection, event) {
      ...
      if (selection.length) {
        _value3 = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["a" /* clearRange */])(_this3.maskOptions, _value3, cursorPos, selection.length);
      }

      var textLen = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["d" /* getInsertStringLength */])(_this3.maskOptions, _value3, text, cursorPos);
      _value3 = Object(__WEBPACK_IMPORTED_MODULE_3__utils_string__["e" /* insertString */])(_this3.maskOptions, _value3, text, cursorPos);
      cursorPos += textLen;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MonthCalendar__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__OutsideClickWrapper__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Head__ = __webpack_require__(30);
...
var MonthCalendar = /** @class */ (function (_super) {
    ...
    function MonthCalendar(props) {
        ...
        _this.getDuration = function (month) {
            var _a = _this.state, selectedMonth = _a.selectedMonth, selectedYear = _a.selectedYear;
        ...
        _this.getRange = function (month) {
            var _a = _this.getDuration(month), selected = _a.selected, duration = _a.duration;
            return Object(__WEBPACK_IMPORTED_MODULE_4__utils__["a" /* rangeCreator */])(selected, duration)
                .map(function (month) { return __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* MONTHS_NAMES */]['default'][month]; });
        };
        _this.isCurrentActiveRange = function (month) {
            var rangeMonth = _this.getRange(month);
            return rangeMonth.indexOf(String(month)) > -1;
        };
        _this.shouldShowActiveRange = function (month) {
            if (_this.isCurrentActiveRange(month)) {
                return 'active';
            }
            return '';
        };
        _this.renderMonths = function () {
            var _a = _this.state, selectedMonth = _a.selectedMonth, selectedYear = _a.selectedYear;
            var _b = _this.props, year = _b.year, rangePicker = _b.rangePicker;
            return __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* MONTHS_NAMES */][_this.props.lang].map(function (month, index) {
                var selectedKlass = (selectedMonth === index && selectedYear === year) ? 'selected_cell active' : '';
                var rangeActive = rangePicker ? _this.shouldShowActiveRange(month) : '';
                return (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { key: index, onClick: function () { return _this.selectMonth(index); }, className: "col_mp span_1_of_3_mp " + selectedKlass + " " + rangeActive }, month));
            });
        };
        ...
        _this.handleMonthRange = function (month) {
            var months = __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* MONTHS_NAMES */]['default'].slice();
            _this.setState({
